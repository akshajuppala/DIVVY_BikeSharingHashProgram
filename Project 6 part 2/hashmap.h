...
// 
// hashmap implements a hash table not assuming a perfect hash function;
...
// function must return a negative value. The class tries to probe through the 
// rest of the array to find the next free space provided there was a collision.
// 
//
...
// 	}
  ...
  //return a vector of all the keys present for the hashmap
